package cn.gmlee.plugin.config;

import cn.gmlee.plugin.entity.*;
 ...
 */
@Data
@State(name = "JasCodeSetting", storages = @Storage("jas-code-setting.xml"))
public class Settings implements PersistentStateComponent<Settings> {
    ...
    public void initDefault() {
        ...
        typeMapperList.add(new TypeMapper("bit(\\(\\d\\))", "java.lang.Boolean"));
