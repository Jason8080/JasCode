package cn.gmlee.plugin.ui.base;
...
public class TemplateEditor {
     ...
     * Jas Code 模板
     */
    public static final String JAS_CODE_TEMPLATE = "JasCodeTemplate.vm.ft";
    /**
     * 项目对象
     */
    ...
    public JComponent createComponent() {
        ...
        LightVirtualFile virtualFile = new LightVirtualFile(JAS_CODE_TEMPLATE, fileType, content, LocalTimeCounter.currentTime());
